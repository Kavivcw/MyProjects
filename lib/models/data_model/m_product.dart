class MProductListResponse {
  final String? message;
  final List<MProduct> data;
  final MPagingResponse? pagingResponse;

  MProductListResponse.named({
    required this.message,
    required this.data,
    required this.pagingResponse,
  });

  factory MProductListResponse(Map<String, dynamic> json) =>
      MProductListResponse.named(
        message: json["message"],
        data:
            List<MProduct>.from(json["data"].map((x) => MProduct.fromJson(x))),
        pagingResponse: json['response'] != null
            ? MPagingResponse.fromJson(json['response'])
            : null,
      );
...
class MProductListResponse2 {
  final String? message;
  final List<MProduct> data;

  MProductListResponse2.named({
    required this.message,
    required this.data,
  });

  factory MProductListResponse2(Map<String, dynamic> json) =>
      MProductListResponse2.named(
        message: json["message"],
        data: List<MProduct>.from(
            json["products"].map((x) => MProduct.fromJson(x))),
      );
...
class MPagingResponse {
  ...
  factory MPagingResponse.fromJson(Map<String, dynamic> json) =>
      MPagingResponse(
        total: json["total"],
        page: json["page"],
        pages: json["pages"],
